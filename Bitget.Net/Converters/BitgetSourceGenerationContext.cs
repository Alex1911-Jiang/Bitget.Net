...
namespace Bitget.Net.Converters
{
    ...
    [JsonSerializable(typeof(BitgetSocketUpdate<BitgetUaTradeUpdate[]>))]
    [JsonSerializable(typeof(BitgetSocketUpdate<BitgetUaLiquidationUpdate[]>))]
    [JsonSerializable(typeof(BitgetSocketUpdate<BitgetUaAccountUpdate[]>))]
    ...
    [JsonSerializable(typeof(BitgetResponse<BitgetUaMaxOpenAvailable>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaAdlRank[]>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaPositionHistory>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaPositionWrapper>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaUserTrades>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaOrders>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaOrder>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaBatchResultWrapper>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaOrderResult>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaAddressBook>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaWithdrawRecord[]>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaWithdrawResult>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaDeposit[]>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaDepositAddress>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaTransferId>))]
    [JsonSerializable(typeof(BitgetResponse<string[]>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaAccountInfo>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaDeltaInfo>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaUserOpenInterestLimit>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaMaxTransferable>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaSwitchStatus>))]
    ...
    [JsonSerializable(typeof(BitgetResponse<BitgetUaOpenInterestLimit[]>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaPositionTier[]>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaLoanInterestRate>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaDiscountRates[]>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaFundingRateHistoryWrapper>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaFundingRate[]>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaKline[]>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaOpenInterest>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaProofOfReserves>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaTrade[]>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaOrderBook>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaSpotSymbol[]>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaMarginSymbol[]>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaFuturesSymbol[]>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaSpotTicker[]>))]
    [JsonSerializable(typeof(BitgetResponse<BitgetUaFuturesTicker[]>))]
    ...
    [JsonSerializable(typeof(BitgetBrokerAgentDirectCommissionItem[]))]
    ...
    [JsonSerializable(typeof(BitgetCopyTradingMarginDetails[]))]
